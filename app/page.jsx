...
export default function Home() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetch("https://script.google.com/macros/s/AKfycbyRRG0VBsStkUCGGsAAkX7LkweovPZI3xvIS5ohcyrd2MrhQNEioJyFiH2nPJJkrcHmkg/exec", {
        method: "POST",
        body: JSON.stringify({
          name: form.name,
          email: form.email,
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <section
         className="relative umrah-hero-section min-h-[480px] md:min-h-[600px] flex flex-col justify-between text-white px-0  bg-gradient-to-b from-emerald-900 to-emerald-700 bg-cover bg-center">
        {/* Light overlay for mobile only */}
        <div className="absolute inset-0 block md:hidden pointer-events-none z-10" style={{ background: 'rgba(26, 83, 85, 0.9)' }}></div>
        <div className="relative z-20">
        {/* Mobile Nav Button */}
        <div className="flex justify-between flex-row-reverse dir-rtl items-center px-4 pt-6 md:hidden">
          <button
            className="p-2 rounded focus:outline-none focus:ring-2 focus:ring-emerald-400"
          ...
          <div className="flex items-center">
              <img src="لوغو مآثر-01-01.png" alt="شركة ماثر" className="object-contain w-[80px] h-[80px]" />
          </div>
        </div>
        ...
        <div
          ref={mobileNavRef}
          className={`fixed top-0 right-0 z-50 h-full w-64 bg-white text-emerald-900 shadow-lg transform transition-transform duration-300 ease-in-out
        ...
        >
          ...
          <nav className="flex flex-col gap-6 text-lg font-medium p-6">
            <a href="#" className="hover:text-emerald-600 transition" onClick={() => setMobileNavOpen(false)}>الرئيسية</a>
            <a href="#rooms" className="hover:text-emerald-600 transition" onClick={() => setMobileNavOpen(false)}>أنواع الغرف</a>
            <a href="#booking-form" className="hover:text-emerald-600 transition" onClick={() => setMobileNavOpen(false)}>احجز الآن</a>
            <a href="#program" className="hover:text-emerald-600 transition" onClick={() => setMobileNavOpen(false)}>البرنامج</a>
            <a href="#sheikh" className="hover:text-emerald-600 transition" onClick={() => setMobileNavOpen(false)}>الشيخ المرافق</a>
          </nav>
        </div>
        ...
        {/* Main hero content */}
        <div className="flex flex-col md:flex-row justify-between items-center w-full max-w-7xl mx-auto px-10 py-10 md:py-24">
          <div className="flex-1 flex flex-col items-start text-right dir-rtl">
            ...
            <div className="mb-6 text-xl md:text-2xl font-semibold text-emerald-200">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="text-center md:text-right">
              <img src="لوغو مآثر-01-01.png" alt="شركة ماثر" className="w-20 h-20 mb-4 mx-auto md:mx-0" />
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-emerald-200">
              © 2025 شركة ماثر للسياحة الدينية - جميع الحقوق محفوظة
            </div>
          </div>
        </div>
      </footer>
